...
var Auth0Provider = function (opts) {
    ...
    useEffect(function () {
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            var appState, isAuthenticated, user, _a, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4: return [4 /*yield*/, client.isAuthenticated()];
                    case 5:
                    ...
                    case 7:
                        user = _a;
                        dispatch({ type: 'INITIALISED', isAuthenticated: isAuthenticated, user: user });
                        return [3 /*break*/, 9];
                    case 8:
                        error_1 = _b.sent();
    ...
    var loginWithPopup = function (options) { return __awaiter(void 0, void 0, void 0, function () {
        var error_2, isAuthenticated, user, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.loginWithPopup(options)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
                ...
                case 7:
                    user = _a;
                    dispatch({ type: 'LOGIN_POPUP_COMPLETE', isAuthenticated: isAuthenticated, user: user });
                    return [2 /*return*/];
            }
        });
    }); };
    return (React.createElement(Auth0Context.Provider, { value: __assign(__assign({}, state), { getAccessTokenSilently: wrappedGetToken(function (opts) {
            ...
            }, loginWithPopup: function (opts) { return loginWithPopup(opts); }, logout: function (opts) { return client.logout(opts); } }) }, children));
};
